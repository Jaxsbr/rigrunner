 ...
 * rig's deck. `kind` is the open vocabulary of part types ('engine', 'storage' today; 'gun',
 * 'harvester', … as they earn their place). New kinds are new string values plus the systems
 * that give them meaning — never new subclasses.
 *
 ...
 */
export type PartKind = 'engine' | 'storage';
