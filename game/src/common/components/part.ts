 ...
 * 'chassis', 'weapon', 'trap-arm' today; more as they earn their place). New kinds are new string
 * values plus the systems that give them meaning — never new subclasses.
 *
 ...
 */
export type PartKind = 'engine' | 'storage' | 'reclaimer' | 'chassis' | 'weapon' | 'trap-arm';
