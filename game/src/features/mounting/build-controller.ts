...
// world height — so the hover gap reads the same on the tall rig deck (0.84) and the low workshop
// deck (0.20), and the part visibly drops as it crosses from rig to workshop. 0.84 of clearance
// clears the rig's deck lips (0.92) with margin.
...
// snap point. (Matches the rig's hover height: rig deckY 0.84 + CARRY_CLEARANCE.)
const CARRY_PLANE_Y = 1.68;
