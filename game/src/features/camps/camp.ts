 ...
 * structures + debris down into the ground, and rises a restorable stump in their place. Disarm is
...
export interface Camp {
   ...
   * (`campSystem`); the view reads it to sink+shrink the camp's structures/debris and rise the stump.
