...
import { addToInventory, getInventory, removeFromInventory } from '../components/inventory';
import { getWallet } from '../components/wallet';
import { partDef, spawnEnginePart } from '../content/parts-catalog';
import { shopItemForPartId, type PartShopItem } from '../content/part-shop';
...
export function buyPart(world: World, item: PartShopItem): PurchaseResult {
  ...
  const entity = spawnEnginePart(world, def);
